...
namespace OC_Seeding_Project.Services
{
        ...
        public async Task<string> Login(string username, string password)
        {
            ...
            catch (FlurlHttpException ex)
            {
                throw new CatalystBaseException(
                    ...
                    "Error logging in to portal. Please make sure your username and password are correct", httpStatus: System.Net.HttpStatusCode.BadRequest);
            }
        }
